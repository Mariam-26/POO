...
//la pratique veut que l'on affiche un objet dans une page differente que celle de la class la classe se trouve dans un fichier externe il prendra une majuscule et qui devra etre nommer du nom de la class ex: Class.php
