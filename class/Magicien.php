...
public$vie =20; /* La classe enfant peut changer la valeur mais seulement de façon inférieure ou égale. C'est à dire que dans l'ordre on à d'abord private puis protected puis public. Si une variable dans le parent est protected on ne pourra pas lui mettre la valeur private qui est au dessus de protected */
